...
class CreateAirportsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('airports', function (Blueprint $table) {
            ...
            $table->string('last_random_seed_generation')->nullable();
            $table->boolean('is_military');
            $table->boolean('has_lights');
            $table->integer('airport_source');
            $table->string('last_very_short_request_date')->nullable();
            $table->string('last_small_trip_request_date')->nullable();
            $table->string('last_medium_trip_request_date')->nullable();
            $table->string('last_short_haul_request_date')->nullable();
            $table->string('last_medium_haul_request_date')->nullable();
            $table->string('last_long_haul_request_date')->nullable();
